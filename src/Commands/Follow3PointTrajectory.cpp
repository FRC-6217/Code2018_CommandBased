...
void Follow3PointTrajectory::Initialize() {
	path.Gen3PointTrajectory(_X1, _Y1, _exitAngle1, _X2, _Y2, _exitAngle2, _X3, _Y3, _exitAngle3);
	path.ConfigureEncoders();
}

// Called repeatedly when this Command is scheduled to run
void Follow3PointTrajectory::Execute() {
	path.FollowTrajectory(driveTrain->GetLEncoderValue(), driveTrain->GetREncoderValue(), driveTrain->GetGyroAngle(), _returnValue);
